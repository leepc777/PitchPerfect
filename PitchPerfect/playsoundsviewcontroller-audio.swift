...
extension PlaySoundViewController: AVAudioPlayerDelegate {
    ...
    func setupAudio() {
        ...
        print("setupAudio inside extended file got called")
        print("optiional variable audioFile:",audioFile,"recordedAudioURL: ",recordedAudioURL)
        do {
    ...
    func setPlayButtonsEnabled(_ enabled: Bool) {
        ...
        hiPitchButton.isEnabled = enabled
        fastButton.isEnabled = enabled
        loPitchButton.isEnabled = enabled
